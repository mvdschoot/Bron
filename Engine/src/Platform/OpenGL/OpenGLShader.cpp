...
bool OpenGLShader::IsBound() { return binded_; }

bool OpenGLShader::IsSet(std::string name) { return uniform_locations_.find(name) != uniform_locations_.end(); }
...
void OpenGLShader::SetUniformMat3(std::string name, const glm::mat3& matrix) {
	u32 loc = uniform_locations_.contains(name) ? uniform_locations_[name]
