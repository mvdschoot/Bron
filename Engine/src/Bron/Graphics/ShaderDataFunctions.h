...
namespace bron
{
	...
	static u32 ShaderDataTypeSize(ShaderDataType type)
	{
		...
		case ShaderDataType::kMat2: return 4 * 2 * 2;
	...
	static GLenum ShaderDataTypeToOpenGLType(ShaderDataType type)
	{
		...
		case ShaderDataType::kMat2: return GL_FLOAT;
		case ShaderDataType::kMat3: return GL_FLOAT;
		case ShaderDataType::kMat4: return GL_FLOAT;
	...
	static u32 ShaderDataTypeElementCount(ShaderDataType type)
	{
		...
		case ShaderDataType::kMat2: return 4;
		case ShaderDataType::kMat3: return 9;
		case ShaderDataType::kMat4: return 16;
		case ShaderDataType::kBool: return 1;
		}
