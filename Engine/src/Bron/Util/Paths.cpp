...
const std::filesystem::path& AssetRoot() { return Root(); }

bool HasAssetRoot() { return !Root().empty(); }
...
std::string ResolveString(const std::filesystem::path& relative) { return Resolve(relative).string(); }
