...
namespace Bron
{
	...
	static void GenerateVao(MeshComponent& mesh, const NamedBufferLayout<VertexVariables>& bufferLayout)
	{
		MeshData& vertexData = mesh.vertexData;
