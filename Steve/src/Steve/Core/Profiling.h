...
// could mark the wrong one in your editor!
	...
	#define CH_PROFILE_BEGIN_SESSION(name, filepath) ::Steve::Instrumentor::Get().BeginSession(name, filepath)
	#define CH_PROFILE_END_SESSION() ::Steve::Instrumentor::Get().EndSession()
	#define CH_PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::Steve::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
											   ::Steve::InstrumentationTimer timer##line(fixedName##line.Data)
